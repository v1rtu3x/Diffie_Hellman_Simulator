...
This project demonstrates a full Diffie-Hellman exchange using:
...
* Shows real cryptography principles
* Demonstrates distributed systems
* Highlights secure communication
